...
optimizer_option = dict(name='SGD', lr=0.001, momentum=0.5, weight_decay=0.0005)

task_option = dict(model=net, save_dir='save_dir_t1', loss_func='mse_loss', lr_schedule_option=lr_schedule_option,
